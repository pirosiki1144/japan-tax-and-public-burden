...
const SCHEMA_NAMES = ["burden", "initial-master-candidate", "initial-master-selection", "change", "event", "phase", "source", "revenue", "national-burden-ratio", "national-burden-ratio-mapping", "distribution-config"];
...
export async function validateRepository(root) {
  ...
  const collections = { burdens: [], candidates: [], changes: [], events: [], phases: [], sources: [], revenues: [], mappings: [], ratios: [], distributionConfigs: [], selectionConfigs: [] };
