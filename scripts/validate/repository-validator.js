...
const SCHEMA_NAMES = ["adapter-inventory", "monitoring-manifest", "format-adapters", "semantic-baseline", "burden", "initial-master-candidate", "initial-master-selection", "monitoring", "change", "event", "phase", "source", "revenue", "national-burden-ratio", "national-burden-ratio-mapping", "distribution-config"];
...
export async function validateRepository(root) {
  ...
  const collections = { adapterInventories: [], monitoringManifests: [], formatAdapters: [], semanticBaselines: [], burdens: [], candidates: [], changes: [], events: [], phases: [], sources: [], revenues: [], mappings: [], ratios: [], distributionConfigs: [], selectionConfigs: [], monitoringTargets: [] };
  ...
  await validateAndCollect(join(root, "config/monitoring-manifest.yaml"), "monitoring-manifest", "monitoringManifests", false);
