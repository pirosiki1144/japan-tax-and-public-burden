...
const SCHEMA_NAMES = ["adapter-inventory", "format-adapters", "national-tax-adapters", "local-tax-adapters", "semantic-baseline", "burden", "initial-master-candidate", "initial-master-selection", "monitoring", "change", "event", "phase", "source", "revenue", "national-burden-ratio", "national-burden-ratio-mapping", "distribution-config"];
...
export async function validateRepository(root) {
  ...
  const collections = { adapterInventories: [], formatAdapters: [], nationalTaxAdapters: [], localTaxAdapters: [], semanticBaselines: [], burdens: [], candidates: [], changes: [], events: [], phases: [], sources: [], revenues: [], mappings: [], ratios: [], distributionConfigs: [], selectionConfigs: [], monitoringTargets: [] };
